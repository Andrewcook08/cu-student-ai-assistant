...
| Muted label | `#555` | Form labels, secondary text |
| Section head bg | `#eee` | `.section__title` |
| Panel bg | `#f5f5f5` | Left filter panel |
| Right pane bg | `#fafafa` | `.empty-space` |
| Border | `#ddd` / `#ccc` | Section dividers, form controls |
| Link | `#0277BD` | `<a>` and `.btn--primary` |
| Body font | `"Helvetica Neue", Helvetica, Arial, sans-serif` | (Tailwind: `font-sans`) |
| Body size | `14px / 1.42857` | Base type scale |
...
│
├── frontend/
│   ├── cu-classes.html             # Static design baseline — 1170-line HTML mockup of CU's
│   │                               #   class search page (markup, embedded CSS, brand tokens,
